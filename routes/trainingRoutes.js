...
router.post('/updateTraining', verifyAccessToken, ensureWriteAccess, trainingController.update_training);
...
router.post('/deleteWorkoutById', verifyAccessToken, ensureWriteAccess, trainingController.delete_workout_by_id);
