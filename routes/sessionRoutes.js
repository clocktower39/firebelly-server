...
router.post("/session-types", verifyAccessToken, sessionTypeController.create_session_type);
router.put("/session-types/:id", verifyAccessToken, sessionTypeController.update_session_type);
router.delete("/session-types/:id", verifyAccessToken, sessionTypeController.delete_session_type);
